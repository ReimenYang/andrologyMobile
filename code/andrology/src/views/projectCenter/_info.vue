  ...
  data () {
    return {
      ...
      infoKeys: [
        ...
        { prop: 'suspendCriteria', label: '中止标准', type: 'input', config: { span: 2 }, repeat: [{ prop: 'suspendCriteria', type: 'textarea', rows: 4 }] },
        { prop: 'therapeuticMethod', label: '治疗方法', type: 'input', config: { span: 2 }, repeat: [{ prop: 'therapeuticMethod', type: 'textarea', rows: 4 }] },
        { prop: 'therapeuticPeriod', label: '治疗周期', type: 'input', config: { span: 2 }, repeat: [{ prop: 'therapeuticPeriod', type: 'textarea', rows: 4 }] },
        { prop: 'curativeEffectCriteria', label: '疗效标准', type: 'input', config: { span: 2 }, repeat: [{ prop: 'curativeEffectCriteria', type: 'textarea', rows: 4 }] },
        { prop: 'projectDesc', label: '项目描述', type: 'input', config: { span: 2 }, repeat: [{ prop: 'projectDesc', type: 'textarea', rows: 4, maxlength: 200 }] },
      ],
      form: {
        projectName: '',
        projectType: '',
