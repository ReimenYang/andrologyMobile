    ...
    async upload (filePath) {
      ...
      return new Promise((resolve, reject) => {
        ...
        uni.uploadFile({
          filePath,
          name: 'file',
          url: `${urlApi}${apiGroup[this.api.group] || apiGroup.admin}${this.api.url || api.admin.sysFile.public.url}`,
