...
import andrology from './andrology'
...
export default { ssyypt, cms, oms, pms, sms, ums, core, admin, adminManage, adminUms, adminCms, adminSsyypt, manageApi, ECirculation, wyjkDevice, adminSms, andrology }
